...
function HoverReceiver() {
  ...
  const loadedFontFamilies = useRef(/* @__PURE__ */ new Set());
  const persistentFontMap = useRef(/* @__PURE__ */ new Map());
  const persistentFontTimeouts = useRef(/* @__PURE__ */ new Map());
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    isVisualEditMode && !isResizing && /* @__PURE__ */ jsx(Fragment, { children: hoverBoxes.filter((box) => box !== null).map((box, index) => /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(
        "div",
        {
    ...
    isVisualEditMode && focusBox && /* @__PURE__ */ jsxs(Fragment, { children: [
      focusTag && /* @__PURE__ */ jsx(
        "div",
        {
      ...
      !isResizing && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(
          "div",
          {
