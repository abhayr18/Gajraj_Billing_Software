...
export default function PrintInvoicePage() {
    return (
        <Suspense fallback={<div className="flex items-center justify-center min-h-screen text-black"><p className="text-lg">Loading...</p></div>}>
            <PrintInvoiceContent />
        </Suspense>
    );
}
...
function PrintInvoiceContent() {
    ...
    useEffect(() => {
        ...
        Promise.all([
            ...
            if (invData.error) { setError('Invoice not found'); setLoading(false); return; }
    ...
    if (loading) return <div className="flex items-center justify-center min-h-screen text-black"><p className="text-lg">Loading invoice...</p></div>;
    if (error) return <div className="flex items-center justify-center min-h-screen text-black"><p className="text-lg text-red-600">{error}</p></div>;
