...
/* ---------- Connection ---------- */
// In Electron, GAJRAJ_DB_PATH points to app.getPath('userData') for persistent storage.
// Falls back to project root for local development.
const DB_PATH = process.env.GAJRAJ_DB_PATH || path.join(process.cwd(), 'gajraj_store.db');
